# Based on: https://github.com/huggingface/transformers/blob/65a89a89768f5922e51cdc7d49990d731e3f2c03/examples/run_lm_finetuning.py
...
def train(args, train_dataset, model, tokenizer):
    ...
    if os.path.exists(args.model_name_or_path):
        try:
            ...
            print("  Continuing training from epoch {}".format(epochs_trained))
            print("  Continuing training from global step {}".format(global_step))
            print("  Will skip the first {} steps in the first epoch".format(steps_trained_in_current_epoch))
        except ValueError:
